...
/**
 * ATTENTION
 * To see where list of setting comes is open res/xml/setting_notification.xml
 */
public class ActivityNotificationSetting extends PreferenceActivity {
...
//            Toast.makeText(getApplicationContext(), "Notif TRUE", Toast.LENGTH_SHORT).show();
//        }else{
//            Toast.makeText(getApplicationContext(), "Notif FALSE", Toast.LENGTH_SHORT).show();
//        }
