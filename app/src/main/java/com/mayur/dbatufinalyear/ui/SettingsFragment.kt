...
import com.mayur.dbatufinalyear.listener.DeviceAdmin
...
class SettingsFragment : Fragment(), View.OnClickListener, View.OnLongClickListener {
    ...
    private fun initObservers() {
        if (prefs.firstSettingsOpen) {
            ...
            viewModel.showMessageDialog(getString(R.string.welcome_to_DBATU_AUTO_SYSTEM_settings))
        }
    ...
    private fun showWallpaperToasts() {
        if (!isDbatuDefault(requireContext()))
